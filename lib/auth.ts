...
// Use SQLite database as recommended in Better Auth docs
...
export const auth = betterAuth({
	...
	plugins: [
        ...
        //             clientId: "app_oTdF0Sepe5DSgzjAO6aHwEeh_FFE", 
        //             discoveryUrl: "https://issuer.hello.coop/.well-known/openid-configuration",
		// 			pkce: true,
		...
		// Stripe plugin disabled for basic demo
		// stripe({
